...
My first solution for controlling a few Somfy RTS blinds was just using the pcb from a https://www.somfy.co.uk/downloads/uk/5054465x00_telis4_rts_en_low_final.pdf[Somfy Telis 4 remote control], and connect some relays to it.
