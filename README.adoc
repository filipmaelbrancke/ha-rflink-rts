...
Home Assistant has an https://www.home-assistant.io/integrations/rflink/[rflink integration] to support the RFLink gateway.
...
For debugging purposes & investigating the context, enable the debug logging for RFLink
